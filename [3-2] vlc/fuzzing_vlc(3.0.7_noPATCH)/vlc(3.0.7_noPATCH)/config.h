...
#define CONFIGURE_LINE "./configure  '--prefix=/home/fuzzing_vlc/vlc-3.0.7.1/install' '--disable-a52' '--disable-lua' '--disable-qt' '--enable-run-as-root' '--with-sanitizer=address' 'CC=afl-clang-fast' 'CXX=afl-clang-fast++'"
...
#define VERSION_MESSAGE "3.0.7.1 Vetinari"

/* compiler */
#define VLC_COMPILER "Selected multilib: .;@m64"
