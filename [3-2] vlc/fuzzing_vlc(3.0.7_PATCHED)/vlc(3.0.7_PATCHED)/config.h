...
#define CONFIGURE_LINE "./configure  '--prefix=/home/vlc-3.0.7.1/install' '--disable-a52' '--disable-lua' '--disable-qt' '--enable-run-as-root' 'CC=afl-clang-fast' 'CXX=afl-clang-fast++'"
