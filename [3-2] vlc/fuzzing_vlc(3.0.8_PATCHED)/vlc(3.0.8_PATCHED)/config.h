...
#define CONFIGURE_LINE "./configure  '--prefix=/home/fuzzing_vlc2/vlc-3.0.8/install' '--disable-a52' '--disable-lua' '--disable-qt' '--enable-run-as-root' 'CFLAGS=-g -O0' 'CXXFLAGS=-g -O0'"
...
#define PACKAGE_VERSION_REVISION 8
...
#define VERSION_MESSAGE "3.0.8 Vetinari"

/* compiler */
#define VLC_COMPILER "gcc version 11.3.0 (Ubuntu 11.3.0-1ubuntu1~22.04)"

/* user who ran configure */
#define VLC_COMPILE_BY "root"

/* host which ran configure */
#define VLC_COMPILE_HOST "6be669f07cda"
